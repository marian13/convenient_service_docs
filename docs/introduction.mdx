...
Yet another approach to revisit the [service object](https://www.toptal.com/ruby-on-rails/decoupling-rails-components) pattern, but this time focusing on the unique, opinionated features.
