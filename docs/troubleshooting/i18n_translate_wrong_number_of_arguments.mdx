...
This exception may happen when `HasResultParamsValidations::UsingActiveModelValidations` plugin is used in an environemnt with [Ruby 3+](https://www.ruby-lang.org/en/news/2020/12/25/ruby-3-0-0-released/) and [Rails 5](https://api.rubyonrails.org/v5.0.0/).
...
2. Or remove `HasResultParamsValidations::UsingActiveModelValidations` plugin from config <br />
