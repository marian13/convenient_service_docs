...
One way to fix that problem is to [activate Amazing Print IRB integration](https://github.com/amazing-print/amazing_print?tab=readme-ov-file#irb-integration).
...
In case you are using [Pry](https://github.com/pry/pry), [Amazing Print has integration for it](https://github.com/amazing-print/amazing_print?tab=readme-ov-file#pry-integration) as well.
