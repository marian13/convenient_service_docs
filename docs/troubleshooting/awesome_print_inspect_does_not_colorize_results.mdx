---
slug: /troubleshooting/awesome_print_inspect_does_not_colorize
sidebar_position: 2
title: "`AwesomePrintInspect` does not colorize"
---

import useBaseUrl from '@docusaurus/useBaseUrl';

Consider a service that includes the `AwesomePrintInspect` configuration.
