---
slug: /advanced_guides/how_to_migrate_from_standard_v1
sidebar_position: 2
title: How to migrate from `Standard::V1`?
---

Consider the following old service that is using the outdated [ConvenientService::Standard::V1::Config](/glossary/standard_v1).
...
4. Repeat the same procedure for the rest services that are using [ConvenientService::Standard::V1::Config](/glossary/standard_v1).
