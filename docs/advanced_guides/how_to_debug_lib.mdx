---
slug: /advanced_guides/how_to_debug_lib
sidebar_position: 5
...
[Convenient Service](/) has already more than [1500 unit and integration tests](https://github.com/marian13/convenient_service/tree/main/spec).
...
- Make sure [Convenient Service](/) is [installed](/convenient_service_docs/installation).
...
- Select any file you need and place a debugger call in it.
  ...
  <img src={useBaseUrl('img/advanced_guides/how_to_debug_lib/byebug.png')} />
