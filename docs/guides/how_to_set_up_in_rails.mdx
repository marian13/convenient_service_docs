...
- Place a configuration file into it.
  ...
  This example utilizes `Standard` or `Rails` config, but you can also pick any other [predefined configuration](./tldr), create customization, or even [have multiple configs](./tldr).
