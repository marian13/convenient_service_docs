...
It has a single public method, often named [`call`](https://blog.eq8.eu/article/ruby-call-method.html) or `run`, `process`, `perform`, etc, that is used to invoke its logic.
